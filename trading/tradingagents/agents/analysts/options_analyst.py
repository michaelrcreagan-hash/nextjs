...
def create_options_analyst(llm):
    ...
    def options_analyst_node(state):
        ...
        system_message = (
            ...
            "\n\n"
            "**Step 3 — Satellite structure by volatility state (bullish regime):**"
            "\n"
            "  - HIGH vol state: sell a 30–45 DTE bull put credit spread below the"
            "    nearest major support (200-SMA or Bollinger lower band); width"
            "    5–10% of spot; target credit ≥ 1/3 of width; manage at 50% profit"
            "    or 21 DTE; hard stop at 2× credit received."
            "\n"
            "  - LOW vol state: premium is cheap — buy a 60–90 DTE bull call debit"
            "    spread (long ~0.60 delta, short ~0.30 delta) or add to the LEAPS;"
            "    stop at 50% of debit paid; take profit at 100% of debit."
            "\n"
            "  - MID vol state: LEAPS diagonal only, no satellite."
            "\n\n"
